      ...
      <div className="container py-awe-160 pt-lg-awe-32 gx-4">
        <div className="row">
          ...
          <div className="ms-auto col-md-7">
            ...
            >
              <p>
                A visão que tenho de advogados é que estão sempre escondidos por
                detrás de grandes escritórios. É algo que chega a assustar o
                cliente do direito. Algo que vai na contramão da nossa missão.
                <span className="text-brand-second">
                  Ao invés de afastar, precisamos acolher.
                </span>
              </p>
              <p>
                Essa é uma visão que carrego desde os primórdios da graduação de
                Direito. Percebo vários problemas no acesso à justiça
                brasileira.
                <span className="text-brand-second">
              ...
              <p>
                ...
                escritório de advocacia 100% digital, full service, com a missão
                ousada de ser o maior do Brasil.
                <span className="text-brand-second">
