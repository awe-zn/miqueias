...
export default function Create({
  ...
  const isAdvocate = useMemo(() => roleToCreate === 'advocate', [roleToCreate]);
  ...
  const handleSubmit = (e) => {
    ...
    const postRoute = isAdvocate
      ? route('advocate.store')
      : route('client.store');
      ...
      <Modal.Body className="p-awe-32">
        <form onSubmit={handleSubmit}>
          <div className="d-flex flex-row gapx-2 align-items-center mb-4">
            <Title
              label={isAdvocate ? 'Adicionar advogado' : 'Adicionar cliente'}
            />
            <button
              type="button"
          ...
          <div className="d-flex flex-column gap-4 mb-awe-64">
            <div>
              <Input
                ...
                placeholder={
                  isAdvocate ? 'Nome do advogado' : 'Nome do cliente'
                }
                status={
                  errors.name
                    ? 'is-invalid'
            ...
            <div>
              <Input
                ...
                handleSetValue={handleSetData}
                placeholder={
                  isAdvocate ? 'E-mail do advogado' : 'E-mail do cliente'
                }
                status={
                  errors.email
                    ? 'is-invalid'
...
Create.propTypes = {
  ...
  roleToCreate: PropTypes.string.isRequired,
};
